...
## Advance TMU address of 'key' to last round-key, as round-keys are applied
## backwards when decrypting
ldi ra32, 0x000000e0
add ra30, ra30, r0;         nop
...
or ra1,  ra13, 0;           nop     # text[1]  = text[13]
or ra13, ra9,  0;           nop     # text[13] = text[9]
or ra9,  ra5,  0;           nop     # text[9]  = text[5]
or ra5,  r0,   0;           nop     # text[5]  = tmp
...
or ra3,  ra7,  0;           nop     # text[3]  = text[7]
or ra7,  ra11, 0;           nop     # text[7]  = text[11]
or ra11, ra15, 0;           nop     # text[11] = text[15]
or ra15, r0,   0;           nop     # text[7]  = tmp
...
shl ra32, ra0, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra34, r0, 0x00000000;   nop         # p = p ^ a
shl ra32, r0, 1;            nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
shl ra32, r0, 1;            nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[0], 0x0e)

xor ra34, ra1, 0x00000000;  nop         # p = p ^ a
shl ra32, ra1, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[1], 0x0b) ^ r3

xor ra34, ra2, 0x00000000;  nop         # p = p ^ a
shl ra32, ra2, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[2], 0x0d) ^ r3

xor ra34, ra3, 0x00000000;  nop         # p = p ^ a
shl ra32, ra3, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra20, r2, r3;           nop         # ra20 = gal_mul(text[3], 0x09) ^ r3


xor ra34, ra0, 0x00000000;  nop         # p = p ^ a
shl ra32, ra0, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[0], 0x09)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[1], 0x0e)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[2], 0x0b) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra21, r2, r3;           nop         # ra21 = gal_mul(text[3], 0x0d) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[0], 0x0d)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[1], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[2], 0x0e) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra22, r2, r3;           nop         # ra22 = gal_mul(text[3], 0x0b) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[0], 0x0b)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[1], 0x0d) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[2], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra23, r2, r3;           nop         # ra23 = gal_mul(text[3], 0x0e) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[4], 0x0e)

xor ra34, ra5, 0x00000000;  nop         # p = p ^ a
shl ra32, ra5, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[5], 0x0b) ^ r3

xor ra34, ra6, 0x00000000;  nop         # p = p ^ a
shl ra32, ra6, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[6], 0x0d) ^ r3

xor ra34, ra7, 0x00000000;  nop         # p = p ^ a
shl ra32, ra7, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra20, r2, r3;           nop         # ra20 = gal_mul(text[7], 0x09) ^ r3


xor ra34, ra4, 0x00000000;  nop         # p = p ^ a
shl ra32, ra4, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[4], 0x09)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[5], 0x0e)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[6], 0x0b) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra21, r2, r3;           nop         # ra21 = gal_mul(text[7], 0x0d) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[4], 0x0d)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[5], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[6], 0x0e) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra22, r2, r3;           nop         # ra22 = gal_mul(text[7], 0x0b) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[4], 0x0b)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[5], 0x0d) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[6], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra23, r2, r3;           nop         # ra23 = gal_mul(text[7], 0x0e) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[8], 0x0e)

xor ra34, ra9, 0x00000000;  nop         # p = p ^ a
shl ra32, ra9, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[9], 0x0b) ^ r3

xor ra34, ra10, 0x00000000; nop         # p = p ^ a
shl ra32, ra10, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[10], 0x0d) ^ r3

xor ra34, ra11, 0x00000000; nop         # p = p ^ a
shl ra32, ra11, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra20, r2, r3;           nop         # ra20 = gal_mul(text[11], 0x09) ^ r3


xor ra34, ra8, 0x00000000;  nop         # p = p ^ a
shl ra32, ra8, 1;           nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[8], 0x09)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[9], 0x0e)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[10], 0x0b) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra21, r2, r3;           nop         # ra21 = gal_mul(text[11], 0x0d) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[8], 0x0d)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[9], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[10], 0x0e) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra22, r2, r3;           nop         # ra22 = gal_mul(text[11], 0x0b) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[8], 0x0b)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[9], 0x0d) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[10], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra23, r2, r3;           nop         # ra23 = gal_mul(text[11], 0x0e) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[12], 0x0e)

xor ra34, ra13, 0x00000000; nop         # p = p ^ a
shl ra32, ra13, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[13], 0x0b) ^ r3

xor ra34, ra14, 0x00000000; nop         # p = p ^ a
shl ra32, ra14, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[14], 0x0d) ^ r3

xor ra34, ra15, 0x00000000; nop         # p = p ^ a
shl ra32, ra15, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra20, r2, r3;           nop         # ra20 = gal_mul(text[15], 0x09) ^ r3


xor ra34, ra12, 0x00000000; nop         # p = p ^ a
shl ra32, ra12, 1;          nop         # a = a << 1
and ra33, r0, rb4;          nop         # if (a & 0x100) then a = a xor 0x11b
shr ra33, r1, 8;            nop
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[12], 0x09)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[13], 0x0e)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[14], 0x0b) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra21, r2, r3;           nop         # ra21 = gal_mul(text[15], 0x0d) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[12], 0x0d)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[13], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[14], 0x0e) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra22, r2, r3;           nop         # ra22 = gal_mul(text[15], 0x0b) ^ r3
...
nop ra39, r1, rb5;          mul24 rb33, r1, rb5
xor ra32, r0, r1;           nop
xor ra35, r0, r2;           nop         # r3 = gal_mul(text[12], 0x0b)
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[13], 0x0d) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra35, r2, r3;           nop         # r3 = gal_mul(text[14], 0x09) ^ r3
...
xor ra32, r0, r1;           nop
xor ra34, r0, r2;           nop         # p = p ^ a
xor ra23, r2, r3;           nop         # ra23 = gal_mul(text[15], 0x0e) ^ r3
